                    ...
                    <div class="row">
                        ...
                        <div class="Loginside pt-0">
                           <div class="row justify-content-center">
							...
							<form class="form" method="POST" action="{{ route('student-update-profile') }}" id="profile" class="" enctype="multipart/form-data" method="post" accept-charset="utf-8" autocomplete="off" novalidate="novalidate">
                            @csrf
