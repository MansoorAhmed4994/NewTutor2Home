...
<head>
	...
	<title>Login Page  :: School, Coaching, Institute Course booking</title>
            ...
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-4">
                    ...
                    <div class="bg bg-white position-relative mb-4">
                        ...
                        <h4>Login</h4>
                        <a href="{{ route('signup') }}" class="signup">Signup</a>
                        <div class="form">
                            <div class="form-group">
                                <a href="{{ route('parent-login') }}" class="btn btn-primary text-white w-100"><span>Parent</span></a>
                            </div>
                            <div class="form-group">
                                <a href="{{ route('student-login') }}" class="btn btn-secondary text-white w-100">Student</a>
                            </div>
                            <div class="form-group">
                                <a href="{{ route('teacher-login') }}" class="btn facebook w-100">Tutor</a>
                            </div>
                        </div>
                    </div>
                    <p>Need help? <a href="">social@tutors2home.com</a></p>
                </div>
            </div>
        </div>
    </div>
